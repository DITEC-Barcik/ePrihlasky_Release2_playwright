...
PODAVATEL_ODVOLANIA_ID = "c49584fa-e2b2-467f-bfec-c960805d85d9"  # TODO: doplnit ID podavatel odvolania pre ZS


class RozhodnutieZS(BasePage):
    ...
    def fill_odvolanie_form(self, den: str, mesiac: str, rok: str):
        ...
        self._safe_click(
            self.page.get_by_text("Podávateľ odvolania (nepovinné)"),
